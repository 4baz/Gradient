...
namespace PLAYER
{
	...
	typedef Player(__fastcall* tPLAYER_ID)();
	static Player PLAYER_ID()
	{
		static tPLAYER_ID oPLAYER_ID = (tPLAYER_ID)(Memory::pattern("48 83 EC 28 80 3D ? ? ? ? ? 74 12 48 8B 0D ? ? ? ? E8 ? ? ? ? 0F B6 40 2D EB 02 33 C0 48 83 C4 28 C3").count(1).get(0).get<void>(0));
		return oPLAYER_ID();
	}
	//static Player PLAYER_ID() { return invoke<Player>(0x4F8644AF03D0E0D6); } // 0x4F8644AF03D0E0D6 0x8AEA886C    //48 83 EC 28 80 3D ? ? ? ? ? 74 12 48 8B 0D ? ? ? ? E8 ? ? ? ? 0F B6 40 2D EB 02 33 C0 48 83 C4 28 C3 

	static Ped PLAYER_PED_ID() { return GET_PLAYER_PED(PLAYER_ID()); };
...
namespace ENTITY
{
	static void _NETWORK_SET_ENTITY_AS_NETWORKED_ENTITY(Entity entity, BOOL toggle) { invoke<Void>(0x3910051CCECDB00C, entity, toggle); } // 0x3910051CCECDB00C 0xD3850671

	//48 89 5C 24 ? 48 8D 64 24 ? 48 83 EC 20 48 8B 41 10 48 89 4C 24 ? 48 8D 64 24 ? 48 8D 64 24 ? 48 8B 5C 24 ? 8B 08 E9 ? ? ? ?
	...
	/*
	typedef void(__fastcall* tSET_ENTITY_INVINCIBLE)(Entity entity, BOOL toggle);
	static void SET_ENTITY_INVINCIBLE(Entity entity, BOOL toggle)
	{
		static tSET_ENTITY_INVINCIBLE oSET_ENTITY_INVINCIBLE = (tSET_ENTITY_INVINCIBLE)(Memory::pattern("48 8B 41 10 83 78 08 00 8B 08 E9 ? ? ? ? 83 F8 FF F8 E9 ? ? ? ? 48 03 05 ? ? ? ?").count(1).get(0).get<void>(0));
		return oSET_ENTITY_INVINCIBLE(entity, toggle);
	}*/
...
/*	typedef void(__fastcall* tSET_EXPLOSIVE_AMMO_THIS_FRAME)(Player player);
	static void SET_EXPLOSIVE_AMMO_THIS_FRAME(Player player)
	{
		static tSET_EXPLOSIVE_AMMO_THIS_FRAME oSET_EXPLOSIVE_AMMO_THIS_FRAME = (tSET_EXPLOSIVE_AMMO_THIS_FRAME)(Memory::pattern("48 83 EC 28 B2 01 E8 ? ? ? ? 48 85 C0 74 0F 48 8B 80 ? ? ? ? 0F BA A8 ? ? ? ? ? 48 83 C4 28 C3").count(1).get(0).get<void>(0));
		return oSET_EXPLOSIVE_AMMO_THIS_FRAME(player);
	}*/
																								//48 83 EC 28 B2 01 E8 ? ? ? ? 48 85 C0 74 0F 48 8B 80 ? ? ? ? 0F BA A8 ? ? ? ? ? 48 83 C4 28 C3 
...
namespace SCRIPT
{
	...
	/*typedef int(__fastcall* tGET_ID_OF_THIS_THREAD)();
	static int GET_ID_OF_THIS_THREAD()
	{
		static tGET_ID_OF_THIS_THREAD oGET_ID_OF_THIS_THREAD = (tGET_ID_OF_THIS_THREAD)(Memory::pattern("48 8D 64 24 ? 48 89 1C 24 48 83 EC 20 51 5B E9 ? ? ? ?").count(1).get(0).get<void>(0));
		return oGET_ID_OF_THIS_THREAD();
	}*/
...
namespace UI
{
	...
	typedef void(__fastcall* tBEGIN_TEXT_COMMAND_DISPLAY_TEXT)(char* text);
	static void BEGIN_TEXT_COMMAND_DISPLAY_TEXT(char* text)
	{
		static tBEGIN_TEXT_COMMAND_DISPLAY_TEXT oBEGIN_TEXT_COMMAND_DISPLAY_TEXT = (tBEGIN_TEXT_COMMAND_DISPLAY_TEXT)(Memory::pattern("48 83 EC 28 E8 ? ? ? ? E8 ? ? ? ? 33 C9 48 85 C0").count(1).get(0).get<void>(0));
		return oBEGIN_TEXT_COMMAND_DISPLAY_TEXT(text);
	}
