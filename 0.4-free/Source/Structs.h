...
#define OFFSET_PLAYER_INFO_WANTED_CAN_CHANGE   0x1C         //1.40  //#define OFFSET_PLAYER_INFO_WANTED_CAN_CHANGE	0x71C			//fWantedCanChange
#define OFFSET_PLAYER_INFO_WANTED              0x98         //1.40 //#define OFFSET_PLAYER_INFO_WANTED				0x798			//wanted level; DWORD
#define	OFFSET_PLAYER_INFO_RUN_SPD			    0x014C //	0xE8			//run speed; def 1; float
#define OFFSET_PLAYER_INFO_SWIM_SPD				0x0148 //0xE4	#define OFFSET_PLAYER_INFO_FRAMEFLAGS			0x190			//frame flags; DWORD
