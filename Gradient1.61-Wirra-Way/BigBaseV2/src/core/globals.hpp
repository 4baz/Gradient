...
namespace big
{
	...
	public:
		...
		{/*
			...
			*/
			this->menu.menux = j["MenuXYPos"]["Xpos"];
			this->menu.menuy = j["MenuXYPos"]["Ypos"];
		//	for (int i = 0; i < 2; i++)
		//		this->menu.menuxy[i] = j["MenuXYPos"]["XposYpos"].at(i);
			
		//	float menuxy[2] = { 0.0f, 0.0f };
		...
		nlohmann::json to_json()
		{
			return nlohmann::json{
			{
				"MenuXYPos",
				{
					{"Xpos",this->menu.menux},
					{"Ypos",this->menu.menuy},
