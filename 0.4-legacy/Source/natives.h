...
namespace VEHICLE
{
	...
	static BOOL IS_THIS_MODEL_A_HELI(Hash model) { return invoke<BOOL>(0xDCE4334788AF94EA, model); } // CREATE_VEHICLE 0x8AF7F568
...
namespace UI
{
	...
	static void _DRAW_SUBTITLE_TIMED(int duration, BOOL drawImmediately) { invoke<Void>(0x9D77056A530643F6, duration, drawImmediately); } // 0x9D77056A530643F6 0x38F82261
...
namespace NETWORKCASH
{
	...
	static char* _NETWORK_SPENT_ON_JOBS(int* p0, int* p1, Any p2) { return invoke<char*>(0x20194D48EAEC9A41, p0, p1, p2); } // 0x20194D48EAEC9A41 0xC5D8B1E9
