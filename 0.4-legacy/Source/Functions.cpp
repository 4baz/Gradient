...
void welcomeMessage() {
	NotifyBottomCentre("https://discord.gg/fTTZSGu");
	notifyAboveMap("Gradient Gta by Sinfool#2522");
	notifyAboveMap("alpha version 0.5.0");
//	notifyAboveMap("Welcome Sinfool or casp3r (if this message is here and you are not Sinfool or casp3r pm sinfool right now!)");
}
