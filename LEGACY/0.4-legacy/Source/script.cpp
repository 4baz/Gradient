...
//https://www.youtube.com/watch?v=mYegD2-jbvg


//  fireammo, entire vehicle subMenu, tp 2 waypoint, dildos
...
int spolieramount = VEHICLE::GET_NUM_VEHICLE_MODS(veh, MOD_SPOILER);
// stop asking for code dumb cunt
...
//player info
bool featureMarkerCurrent = false; 
bool featureMarkerSelected = false;
...
void addDevTitle(char *title) {

	drawSprite("CommonMenu", "shopui_title_sm_hangar", 0.827f, 0.06f, 0.225f, 0.09f, 0, devbannerRect.R, devbannerRect.G, devbannerRect.B, devbannerRect.A);

	drawText("gradient dev", 1, 0.827f, 0.036f, 0.77f, 0.77f, bannerText.R, bannerText.G, bannerText.B, bannerText.A, TRUE/*, FALSE*/);


	drawText("This sub is for sinfool only", 7, 0.850f, secondTitleY, 0.35f, 0.35f, secondTitleRed, secondTitleGreen, secondTitleBlue, secondTitleOpacity, FALSE/*, FALSE*/);
...
void addLscTitle(char *title) {
	drawSprite("shopui_title_carmod", "shopui_title_carmod", 0.827f, 0.06f, 0.225f, 0.09f, 0, 255, 255, 255, 255);

//	drawText("gradient", 1, 0.827f, 0.036f, 0.77f, 0.77f, bannerText.R, bannerText.G, bannerText.B, bannerText.A, TRUE/*, FALSE*/);


	drawText("major wip", 7, 0.850f, secondTitleY, 0.35f, 0.35f, secondTitleRed, secondTitleGreen, secondTitleBlue, secondTitleOpacity, FALSE/*, FALSE*/);

	drawText(title, 0, secondTitleX, secondTitleY, 0.35f, 0.35f, secondTitleRed, secondTitleGreen, secondTitleBlue, secondTitleOpacity, FALSE/*, FALSE*/);
}
void addhangerTitle(char *title) {

	drawSprite("shopui_title_sm_hangar", "shopui_title_sm_hangar", 0.827f, 0.06f, 0.225f, 0.09f, 0, 255, 255, 255, 255);

	//	drawText("gradient", 1, 0.827f, 0.036f, 0.77f, 0.77f, bannerText.R, bannerText.G, bannerText.B, bannerText.A, TRUE/*, FALSE*/);


	drawText(" v0.4.2", 7, 0.850f, secondTitleY, 0.35f, 0.35f, secondTitleRed, secondTitleGreen, secondTitleBlue, secondTitleOpacity, FALSE/*, FALSE*/);
...
//	drawSprite("CommonMenu", "shopui_title_sm_hangar", 0.827f, 0.06f, 0.225f, 0.09f, 0, bannerRect.R, bannerRect.G, bannerRect.B, bannerRect.A);


	drawText("gradient", 1, 0.827f, 0.036f, 0.77f, 0.77f, bannerText.R, bannerText.G, bannerText.B, bannerText.A, TRUE/*, FALSE*/);
	
	
	drawText("alpha v0.4.2", 7, 0.870f, secondTitleY, 0.35f, 0.35f, secondTitleRed, secondTitleGreen, secondTitleBlue, secondTitleOpacity, FALSE/*, FALSE*/);
	
	
		//drawText("Developed by Sinfool#2522", 1, 0.845, 0.132f, 0.50f, 0.40f, titleTextRed, titleTextGreen, titleTextBlue, titleTextOpacity, true);



	drawText(title, 7, secondTitleX, secondTitleY, 0.35f, 0.35f, secondTitleRed, secondTitleGreen, secondTitleBlue, secondTitleOpacity, FALSE/*, FALSE*/);
...
float menux = 0.2f;
void addLeftTitle() {
	drawText(PLAYER::GET_PLAYER_NAME(selectedPlayer) , 7, menux, 0.095f, 0.85f, 0.85f, bannerText.R, bannerText.G, bannerText.B, bannerText.A, true);
	drawSprite("commonmenu", "interaction_bgd", menux, 0.1175f, 0.23f, 0.085f, 0.0f, bannerRect.R, bannerRect.G, bannerRect.B, bannerRect.A);
	drawRect(menux - 0.116f, 0.116f, 0.002f, 0.085f, border);
	drawRect(menux + 0.116f, 0.116f, 0.002f, 0.085f, border);
	drawRect(menux, 0.0745f, 0.230f, 0.004f, border);

}

void addLeftOption() {
	drawRect(menux , 0.1200f, 0.23f, 0.035f, border);
...
bool addoptioninbool(char *option, char *info = NULL) {
	optionCount++;
	if (currentOption == optionCount)
		infoText = info;
	if (currentOption <= maxOptions && optionCount <= maxOptions)
	...
	void changemodoption(char *option, int type, int index, char *info = NULL)
	{
...
// options to replace the on/off

//https://gyazo.com/061af9eef81c5c1669b8822473e78651
...
void addbool2(char* option, bool b00l, char* text = "", bool meg = false)
{
	...
	//	drawSprite("timerbars", "circle_checkpoints_outline", mainTextX - 0.850f, (optionCount * 0.035f + mainTextY), 16, 16, 0, 0, 17, 255, 255); //blue ON
		addOption(buf);
	}
	else
	{
		_snprintf(buf, sizeof(buf), "%s ~r~OFF", option);
	//	drawSprite("timerbars", "circle_checkpoints_outline", mainTextX - 0.850f, (optionCount * 0.035f + mainTextY), 16, 16, 0, 196, 4, 4, 255); //red OFF
		addOption(buf);
	}
}
...
void DrawText2(char * text, int font, float x, float y, float scale, int r, int b, int g, int a, bool isGxtEntry, bool center, bool isjustify = 0, float warpend = 1.0f)
{
	UI::SET_TEXT_FONT(font);
	UI::SET_TEXT_SCALE(x, y);
	UI::SET_TEXT_COLOUR(r, g, b, a);
	UI::SET_TEXT_WRAP(0.0f, 1.0f);
	UI::SET_TEXT_CENTRE(center);
	UI::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
...
{	//	bool result = KeyJustUp(VK_F9);
	...
	if (GetTickCount() - DelayCounter > 150)
	{
		...
		else if (getKeyPressed(VK_NUMPAD0) || CONTROLS::IS_DISABLED_CONTROL_PRESSED(0, INPUT_PUSH_TO_TALK) && submenu != 0)//exit
			{
				DelayCounter = GetTickCount();
				if (submenu == Main_Menu)
				{
	...
	if (dildomoneylocal == TRUE) {
		Ped iPed = PLAYER::PLAYER_PED_ID();
		{
			...
			//		int CashHash = -1803909274;  // prop_paper_bag_small = -1803909274
				//	int CashHash = 683570518;   // prop_amb_beer_bottle = 683570518
					int PickupHash = GAMEPLAY::GET_HASH_KEY("PICKUP_MONEY_PURSE");
...
//					int CashHash = 683570518;   // prop_amb_beer_bottle = 683570518
	...
	if (rainbowcar == true) {
		if ((timeGetTime() - TimePD2) > 100) // Time between drops
		{
	...
	if (cageplayer == true) {
		...
		if (NETWORK::NETWORK_IS_PLAYER_CONNECTED(selectedPlayer) && ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(selectedPlayer)))
		{
			...
			AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::GET_PLAYER_PED(selectedPlayer));
			OBJECT::CREATE_OBJECT_NO_OFFSET(206865238, coords.x - 1.39f, coords.y - 1.87f, coords.z - 1.0f, /*0.0f, 0.0f,*/ -0.66576f, /*0.746166f,*/ false, true);
			OBJECT::CREATE_OBJECT_NO_OFFSET(206865238, coords.x + 1.51f, coords.y + 1.94f, coords.z - 1.0f, /*0.0f, 0.0f,*/ 0.75172f, /*0.659482f,*/ false, true);
		}
	}
	...
	if (freecam == true) {
		...
		ENTITY::SET_ENTITY_VISIBLE(local_ped, !freecam, !freecam);
		ENTITY::SET_ENTITY_COLLISION(local_ped, !freecam, true);
		...
		if (GetAsyncKeyState(VK_KEY_S) || CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(2, 268)) {
			float fivef = .5f;
			float heading = ENTITY::GET_ENTITY_HEADING(local_ped);
		...
		if (GetAsyncKeyState(VK_KEY_A) || CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(2, 266)) {
			float fivef = .5f;
			float heading = ENTITY::GET_ENTITY_HEADING(local_ped);
			ENTITY::SET_ENTITY_HEADING(local_ped, heading + 0.5f);
		}
...
#pragma region Main Menu
			case Main_Menu:
				...
				addSubmenuOption("Self Options", Self_Options, "Wawixs is pretty cool");
				addSubmenuOption("Weapon Options", weapons_options, "so is casp3r");
				addSubmenuOption("Teleport", tp_options, "Kiro is my daddy");
			//	addSubmenuOption("Vehicle options", Vehicle_options, "Paulth is a verified cunt");
				addSubmenuOption("Recovery", recovery, "Enough007 likes rick and morty");
				addSubmenuOption("Players List", Players_List, "The infamous devs are bae");
				addSubmenuOption("Settings", Settings, "Gilliam is a cunt");
				addSubmenuOption("Credits", credits, "Unban me on xen pls ;p");
				break;
#pragma endregion
#pragma region dev
			case dev_options:
				addDevTitle("dev shit");
				addOption("shitty test op ");
				addOption("shitty test op ");
				addOption("shitty test op ");
				addOption("shitty test op ");
				addOption("shitty test op ");
...
#pragma region tp options
			case tp_options:
				addTitle("Teleports");
			//	addOption("tp to waypoint", "you wanted it you got it :P");
...
#pragma region recovery
			case recovery:
				...
				addSubmenuOption("Offline Recovery", offline_recovery_warning, "FOR OFFLINE!");
				break;
#pragma endregion
#pragma region offline recovery warning
			case offline_recovery_warning:
				addTitle("WARNING!");
				addOption("GTA STORY MODE ONLY");
				addSubmenuOption("Click here to continue", offline_recovery);
				break;
#pragma endregion
...
#pragma region cash recovery
			case cash_recovery_online:
				...
				addBoolOption("2k drop", dildomoneylocal, "sexy");
				//	addOption("(may not work) 15mil stealth");
				switch (getOption())
				{
				...
				if (UNK3::_NETWORK_SHOP_BEGIN_SERVICE(&transactionID, 1474183246, 312105838, 1445302971, 8000000, 4))
...
#pragma region credits
			case credits:
				addTitle("Credits");
				addOption("Click here to join the gradient Discord");
				...
				addOption("sub1to for subVersion's hook");
				addOption("---------------------------------------");
				addOption("worked on by:");
				addOption("Sinfool#2522");
				if (getOption() == 1) {
					ShellExecute(NULL, L"open", L"https://discord.gg/3WXWH9U", NULL, NULL, SW_SHOWNORMAL);
				}
...
#pragma region Player Options
			case Player_Options:
				...
				addBoolOption("2k drop", dildmoney, "sexy");
			//	addBoolOption("cage player", cageplayer, "Wow you are a dickhead");

				switch (getOption())
				{
				case 1: dildmoney = !dildmoney; break;
				case 2: cageplayer = !cageplayer; break;
				}
...
#pragma region Self Options
			case Self_Options:
				...
				addBoolOption("Super Jump", superjump);  // broken on 1.41 need to get the sig
			//	addBoolOption("Free Cam", freecam);

				switch (getOption())
				{
				case 2: god = !god; break;
...
#pragma region vehicle options
			case Vehicle_options:
				...
				addSubmenuOption("Sinfool's Garage", lsc);
				addBoolOption("tp into vehicle", spawnincar);
				addBoolOption("Spawn car maxed", spawnmaxed);
				addBoolOption("Rainbow Car", rainbowcar);
				addBoolOption("God Car", godcar);
				addOption("Fix Car");
				switch (getOption())
				{
				case 3: spawnincar = !spawnincar; break;
				case 4: spawnmaxed = !spawnmaxed; break;
				case 5: rainbowcar = !rainbowcar; break;
				case 6: godcar = !godcar; break;
				}
				if (getOption() == 7) {
...
#pragma region lsc
			case lsc:
				addLscTitle("Sinfool's Garage");
				addOption("Max vehicle");
				addSubmenuOption("Armor Mods", vehiclearmor);
				addSubmenuOption("Engine Mods", enginemods);
				addSubmenuOption("Spolier Mods", spoliermods);
				addSubmenuOption("Front bumper Mods", frontbumpermods);
				if (getOption() == 1) {
				...
				break;
#pragma endregion
#pragma region front bumper
			case frontbumpermods:
				addLscTitle("Front Bumper Mods");
				changemodoption("stock bumper", MOD_FRONTBUMPER, -1);
				changemodoption("Level 1 bumper", MOD_FRONTBUMPER, 0);
				changemodoption("Level 2 bumper", MOD_FRONTBUMPER, 1);
				changemodoption("Level 3 bumper", MOD_FRONTBUMPER, 2);
				changemodoption("Level 4 bumper", MOD_FRONTBUMPER, 3);
				changemodoption("Level 5 bumper", MOD_FRONTBUMPER, 4);
				break;
#pragma endregion
#pragma region armor mods
			case vehiclearmor:

				addLscTitle("Armor Mods");
				changemodoption("no armor", MOD_ARMOR, -1);
				changemodoption("20% armor", MOD_ARMOR, 0);
				changemodoption("40% armor", MOD_ARMOR, 1);
				changemodoption("60% armor", MOD_ARMOR, 2);
				changemodoption("88% armor", MOD_ARMOR, 3);
				changemodoption("100% armor", MOD_ARMOR, 4);
				break;
#pragma endregion
#pragma region engine mods
			case enginemods:
				addLscTitle("Engine Mods");
				changemodoption("stock ems", MOD_ENGINE, -1);
				changemodoption("ems level 1", MOD_ENGINE, 0);
				changemodoption("ems level 2", MOD_ENGINE, 1);
				changemodoption("ems level 3", MOD_ENGINE, 2);
				changemodoption("ems level 4", MOD_ENGINE, 3);
				break;
#pragma endregion
#pragma region spolier mods
			case spoliermods:
				addLscTitle("spoiler mods");
				changemodoption("no spoiler", MOD_SPOILER, -1);
				changemodoption("level 1 spoiler", MOD_SPOILER, 0);
				changemodoption("level 2 spoiler", MOD_SPOILER, 1);
				changemodoption("level 3 spoiler", MOD_SPOILER, 2);
				changemodoption("level 4 spoiler", MOD_SPOILER, 3);
				changemodoption("level 5 spoiler", MOD_SPOILER, 4);
				//	changemodoption((UI::_GET_LABEL_TEXT(VEHICLE::GET_MOD_TEXT_LABEL(veh, MOD_SPOILER, i))), MOD_SPOILER, i);
