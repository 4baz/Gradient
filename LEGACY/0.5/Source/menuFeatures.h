...
bool AddTestInt(char *option, int & iNt, int min, int max, int step, char *info);
void AddFloat(char* option, float *floattochange, float min, float max, float increments, char *info);
void AddTestFloat(char* option, float floattochange, float min, float max, float increments, char *info);
