...
namespace SCRIPT
{
	...
	static BOOL GET_EVENT_DATA(BOOL p0, int eventIndex, int *eventData, int p3) { return invoke<BOOL>(0x2902843FCD2B2D79, p0, eventIndex, eventData, p3); } // 0x2902843FCD2B2D79 0x4280F92F
	...
	static void TRIGGER_SCRIPT_EVENT(BOOL p0, void* argsStruct, int argsStructSize, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argsStructSize, bitset); } // 0x504D0D40319365B7 0x54763B35
...
namespace UNK3
{
	...
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(int* serviceIDOut, Any p1, Any p2, Any p3, int amount, int p5) { return invoke<BOOL>(0x3C5FD37B5499582E, serviceIDOut, p1, p2, p3, amount, p5); } // 0x3C5FD37B5499582E
	...
	static BOOL _NETWORK_TRANSFER_BANK_TO_WALLET(int charStatInt, int amount) { return invoke<BOOL>(0xD47A2C1BA117471D, charStatInt, amount); } // 0xD47A2C1BA117471D //btw
	static BOOL _NETWORK_TRANSFER_WALLET_TO_BANK(int charStatInt, int amount) { return invoke<BOOL>(0xC2F7FE5309181C7D, charStatInt, amount); } // 0xC2F7FE5309181C7D //wtb
